        ...
        children: [
          StreamBuilder<List<UsersRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<UsersRecord> topDarkSectionUsersRecordList = snapshot.data!;
              // Return an empty Container when the item does not exist.
              if (snapshot.data!.isEmpty) {
                return Container();
              }
              final topDarkSectionUsersRecord =
                  topDarkSectionUsersRecordList.isNotEmpty
                      ? topDarkSectionUsersRecordList.first
                      : null;
              return Container(
